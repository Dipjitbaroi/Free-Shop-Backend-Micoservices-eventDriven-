...
-- CreateIndex
CREATE INDEX "SellerReport_sellerId_idx" ON "SellerReport"("sellerId");

-- CreateIndex
CREATE INDEX "SellerReport_date_idx" ON "SellerReport"("date");

-- CreateIndex
CREATE UNIQUE INDEX "SellerReport_sellerId_date_key" ON "SellerReport"("sellerId", "date");
