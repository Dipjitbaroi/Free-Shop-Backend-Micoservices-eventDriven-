...
export const PERMISSION_CODES = {
  ...
  CATEGORY_CREATE: 5101,
  CATEGORY_READ: 5102,
  CATEGORY_UPDATE: 5103,
  CATEGORY_DELETE: 5104,

  // Subcategory permissions
  SUBCATEGORY_CREATE: 5201,
  SUBCATEGORY_READ: 5202,
  SUBCATEGORY_UPDATE: 5203,
  SUBCATEGORY_DELETE: 5204,
...
export const ROLE_PERMISSIONS = {
  ...
  ADMIN: [
    ...
    PERMISSION_CODES.CATEGORY_READ,
    PERMISSION_CODES.CATEGORY_UPDATE,
    PERMISSION_CODES.CATEGORY_DELETE,
    PERMISSION_CODES.SUBCATEGORY_CREATE,
    PERMISSION_CODES.SUBCATEGORY_READ,
    PERMISSION_CODES.SUBCATEGORY_UPDATE,
    PERMISSION_CODES.SUBCATEGORY_DELETE,
    ...
    PERMISSION_CODES.BANNER_READ,
    PERMISSION_CODES.BANNER_UPDATE,
    PERMISSION_CODES.BANNER_DELETE,
    PERMISSION_CODES.BANNER_REORDER,
  ],
  MANAGER: [
    PERMISSION_CODES.USER_READ,
    PERMISSION_CODES.USER_MANAGEMENT_UPDATE,
