...
// Load .env from inventory-service
const envPath = path.resolve('d:/GitHub/Free-Shop-Backend-Micoservices(eventDriven)/services/inventory-service/.env');
