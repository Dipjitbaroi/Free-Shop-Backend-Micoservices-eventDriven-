...
CREATE TABLE "free_items" (
    ...
    CONSTRAINT "free_items_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "free_items_productId_idx" ON "free_items"("productId");
...
-- AddForeignKey
ALTER TABLE "free_items" ADD CONSTRAINT "free_items_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
