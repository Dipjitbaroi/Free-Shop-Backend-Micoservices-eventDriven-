-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_CREATED', 'ORDER_CONFIRMED', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_CANCELLED', 'PAYMENT_RECEIVED', 'PAYMENT_FAILED', 'PAYMENT_REFUNDED', 'SELLER_VERIFIED', 'SELLER_SUSPENDED', 'WITHDRAWAL_COMPLETED', 'WITHDRAWAL_REJECTED', 'LOW_STOCK_ALERT', 'PRICE_DROP', 'BACK_IN_STOCK', 'WELCOME', 'PASSWORD_RESET', 'EMAIL_VERIFICATION', 'PROMOTION', 'CUSTOM');
...
CREATE TABLE "NotificationPreference" (
    ...
    "sellerUpdates" BOOLEAN NOT NULL DEFAULT true,
